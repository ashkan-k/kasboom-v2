...
<head>
  ...
  <link rel="stylesheet" href="v4_assets/css/bootstrap.rtl.min.css">
  <link rel="stylesheet" href="v4_assets/scss/main.css">
  ...
  <div class="wrapper-loading">
    <div class="inner">
      <div class="load-image">
        <img src="v4_assets/images/loading.svg" alt="">
      </div>
    </div>
  </div>
            ...
            <div class="swiper swiper-login" dir="rtl">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="item">
                    <div class="img-container" style="background-image: url('v4_assets/images/bg/login-1.jpg')">
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="item">
                    <div class="img-container" style="background-image: url('v4_assets/images/bg/login-2.jpg')">
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="item">
                    <div class="img-container" style="background-image: url('v4_assets/images/bg/login-3.jpg')">
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="item">
                    <div class="img-container" style="background-image: url('v4_assets/images/bg/login-4.jpg')">
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="item">
                    <div class="img-container" style="background-image: url('v4_assets/images/bg/login-5.jpg')">
                    </div>
                  </div>
                </div>
              </div>
