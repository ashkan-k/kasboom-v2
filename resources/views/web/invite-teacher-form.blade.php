                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        <div class="select-group mt-0 mb-4">
                            <select name="madrak" class="form-select mt-0" aria-label="advice type">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        <div class="inputgroup mt-0 mb-4">
                            <input name="reshte" type="text" class="myinput" placeholder="رشته تحصیلی (آخرین وضعیت تحصیلی)"
                                   ...
                                   autocomplete="on">
                            <label>رشته تحصیلی (مطابق آخرین وضعیت تحصیلی)</label>
...
{{--                            </div>--}}
                    ...
                    <div class="col-12">
                        <div class="card-upload">
                            <h6 class="upload-title">بارگذاری فیلم</h6>
