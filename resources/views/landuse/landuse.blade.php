...
@section('Content')
    <!-- Amayesh -->
    <div class="page-background type-3">
    ...
    <div class="amayesh-page">
        <div class="container-lg">
            <div class="amayesh-map-content">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="city-list">
                            <div class="city-inner">
                                <div class="city-item">
                                    <a href="landuseitem/azar-east">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/azar-sh.jpg" alt="آذربایجان شرقی"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>آذربایجان شرقی</h2>
                                        </div>
                                    </a>
                                </div>
                                <div class="city-item">
                                    <a href="landuseitem/azar-west">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/azar-gh.jpg" alt="آذربایجان غربی"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>آذربایجان غربی</h2>
                                        </div>
                                    </a>
                                </div>
                                <div class="city-item">
                                    <a href="landuseitem/ardabil">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/ardabil.jpg" alt="اردبیل"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>اردبیل</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/isfahan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/isfahan.jpg" alt="اصفهان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>اصفهان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/alborz">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/alborz.jpg" alt="البرز"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>البرز</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/ilam">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/ilam.jpg" alt="ایلام"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>ایلام</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/boushehr">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/boushehr.jpg" alt="بوشهر"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>بوشهر</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/tehran">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/tehran.jpg" alt="تهران"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>تهران</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/chahar-mahaal-bakhtiari">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/chahar.jpg" alt="چهارمحال بختیاری"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>چهارمحال بختیاری</h2>
                                        </div>
                                    </a>
                                </div>
                                <div class="city-item">
                                    <a href="landuseitem/khorasan-j">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/khorasan-j.jpg" alt="خراسان جنوبی"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>خراسان جنوبی</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/khorasan-r">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/khorasan-r.jpg" alt="خراسان رضوی"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>خراسان رضوی</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/khorasan-sh">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/khorasan-sh.jpg" alt="خراسان شمالی"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>خراسان شمالی</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/khozestan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/khozestan.jpg" alt="خوزستان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>خوزستان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/zanjan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/zanjan.jpg" alt="زنجان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>زنجان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/semnan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/semnan.jpg" alt="سمنان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>سمنان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/sistan-baluchestan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/sistan.jpg" alt="سیستان و بلوچستان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>سیستان و بلوچستان</h2>
                                        </div>
                                    </a>
                                </div>
                                <div class="city-item">
                                    <a href="landuseitem/fars">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/fars.jpg" alt="فارس"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>فارس</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/qazvin">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/qazvin.jpg" alt="قزوین"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>قزوین</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/qom">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/qom.jpg" alt="قم"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>قم</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/kordestan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/kordestan.jpg" alt="کردستان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>کردستان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/kerman">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/kerman.jpg" alt="کرمان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>کرمان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/kermanshah">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/kermanshah.jpg" alt="کرمانشاه"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>کرمانشاه</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/kohgiluyeh-boyer-ahmad">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/kohkilo.jpg" alt="کهگیلویه و بویر احمد"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>کهگیلویه و بویر احمد</h2>
                                        </div>
                                    </a>
                                </div>
                                <div class="city-item">
                                    <a href="landuseitem/golestan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/golestan.jpg" alt="گلستان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>گلستان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/gilan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/gilan.jpg" alt="گیلان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>گیلان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/lorestan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/lorestan.jpg" alt="لرستان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>لرستان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/mazandaran">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/mazandaran.jpg" alt="مازندران"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>مازندران</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/markazi">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/markazi.jpg" alt="مرکزی"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>مرکزی</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/hormozgan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/hormozgan.jpg" alt="هرمزگان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>هرمزگان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/hamedan">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/hamedan.jpg" alt="همدان"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>همدان</h2>
                                        </div>
                                ...
                                <div class="city-item">
                                    <a href="landuseitem/yazd">
                                        <div class="city-image">
                                            <img src="_upload_/_landuse_/index/yazd.jpg" alt="یزد"/>
                                        </div>
                                        <div class="city-name">
                                            <h2>یزد</h2>
                                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="map-content sticky-top">
                            <div class="map-inner">
                                <svg id="iran-map" viewBox="0 0 970 960" x="0px" y="0px">
                                    <g class="map-line">
                                    ...
                                    <g class="map-city">
                                        <a href="landuseitem/alborz">
                                            <path class="citymap-name city-alborz" data-tooltip="البرز" d="M302,227.9c-2.2-1.3-0.7-5.8,1.9-4.6c6.4,1,12.8,2.3,19.2,3.7c5.3,1,9.3,4.9,14.3,6.6c2.3,0.9,4.7,1.7,7,2.5
                                        ...
                                        <a href="landuseitem/ardabil">
                                            <path class="citymap-name city-ardabil" data-tooltip="اردبیل" d="M181.2,24.2c2.5-2.7,6.4-5.7,10.2-3.6c6.6,4.3,11.2,10.9,16.3,16.7c-3.1,1.2-6.4,2.1-9,4.3
                                        ...
                                        <a href="landuseitem/azar-east">
                                            <path class="citymap-name city-azarbayejan-east"
                                                  data-tooltip="آذربایجان شرقی" d="M136.9,51.8c2.1-2.8,6-1.7,9-2.3c0.3,6.1-0.4,12.2,0.3,18.3c0.2,2,2.2,2.9,3.4,4.2c1.9-2.5,3.7-5.2,5.9-7.5
                                        ...
                                        <a href="landuseitem/azar-west">
                                            <path class="citymap-name city-azarbayejan-west"
                                                  data-tooltip="آذربایجان غربی" d="M29.6,10.2c2-1.5,3.9-3,5.9-4.5c2.3,3.8,5.8,6.7,10.3,7c0.4,2.5,0.8,4.9,1.2,7.4c2.9,2.6,6.3,4.9,8,8.6
                                        ...
                                        <a href="landuseitem/boushehr">
                                            <path class="citymap-name city-boshehr" data-tooltip="بوشهر" d="M274.4,583.8c0.8-1,1.5-1.9,2.3-2.9c2,1.4,3.9,3.2,6.3,3.8c2.7,0.1,5.4-0.8,8.1-0.6c3.2,1,6.9,3,7.5,6.7
                                        ...
                                        <a href="landuseitem/chahar-mahaal-bakhtiari">
                                            <path class="citymap-name city-bakhtiary" data-tooltip="چهارمحال بختیاری"
                                                  d="M302,444.8c5.5-0.2,11.1-0.7,15.9-3.7c0,4.9-0.3,10,1,14.8c1.3,4.6,5.1,7.7,8.1,11.1c3.9,4,6.5,9.1,8.8,14.1
                                        ...
                                        <a href="landuseitem/fars">
                                            <path class="citymap-name city-shiraz" data-tooltip="شیراز" d="M365.8,509.4c4.2-4.3,8.6-8.3,13.6-11.7c1.5,3.1,2.3,7.4,5.9,8.9c6.2,2.6,13.1,2.7,19.8,2.4
                                        ...
                                        <a href="landuseitem/gilan">
                                            <path class="citymap-name city-gilan" data-tooltip="گیلان" d="M218.1,99.2c4.3,0,8.5-0.4,12.8-1.1c-0.8,9.6,0.1,19.2,1.6,28.7c1.3,5.9,2.1,12.6,6.5,17.1
                                        ...
                                        <a href="landuseitem/golestan">
                                            <path class="citymap-name city-golestan" data-tooltip="گلستان" d="M541.1,122.7c6.8-1.7,14-2.2,20.9-0.4c4.4,1.2,9,0.5,13.4-0.3c-2.8,5.9-3.3,12.6-4.7,19c1.7,3,4.4,5.2,6.2,8.1
                                        ...
                                        <a href="landuseitem/hamedan">
                                            <path class="citymap-name city-hamedan" data-tooltip="همدان" d="M184.6,254c5.6,2.1,9.4,6.9,14.1,10.1c2.1-0.6,4-1.7,6.1-2.3c4.6,1.7,8,6.3,13.2,6.3c3.9,0.5,3.7-4.8,4.9-7.4
                                        ...
                                        <a href="landuseitem/hormozgan">
                                            <path class="citymap-name city-hormozgan" data-tooltip="هرمزگان" d="M564.2,668.3c3.9-3.7,8.2-7.1,13.1-9.3c0.5,6.7,1.4,13.3,1.8,20c0.4,4.2-1.6,8-2.2,12.1c0.8,3,3.7,4.8,5.8,6.9
                                        ...
                                        <a href="landuseitem/ilam">
                                            <path class="citymap-name city-ilam" data-tooltip="ایلام" d="M74.1,353.2c5.7,0.3,11.7-2.4,17.1,0.4c3.3,1.3,7,1.9,9.7,4.3c4.4,3.8,8.6,8,14.3,9.8
                                        ...
                                        <a href="landuseitem/isfahan">
                                            <path class="citymap-name city-isfahan" data-tooltip="اصفهان" d="M361.5,334.5c5.1-2.3,10.1,1.2,15.1,2.1c8.1,1.4,16.5-0.7,24.7,1.2c8.5,1.8,16.1,6.7,24.8,7.3
                                        ...
                                        <a href="landuseitem/kerman">
                                            <path class="citymap-name city-kerman" data-tooltip="کرمان" d="M607,479.1c3.6-2.5,7.8,0.3,11,2.2c8.2,5.6,18.2,7.5,27.1,11.8c5.9,3,12.5,3.9,18.5,6.5
                                        ...
                                        <a href="landuseitem/kermanshah">
                                            <path class="citymap-name city-kermanshah" data-tooltip="کرمانشاه" d="M93.2,279.6c5.9,4.8,11.3,10.4,14.8,17.2c1.5,3,3.9,5.3,6.4,7.4c0.3,1.7,0.6,3.5,1.1,5.2
                                        ...
                                        <a href="landuseitem/khorasan-j">
                                            <path class="citymap-name city-khorasan-north" data-tooltip="خراسان شمالی"
                                                  d="M587.4,112.7c4.5-1.2,9.1-2,13.7-2.4c5.3-0.2,10.3,5.8,15.4,2.5c1.6-0.8,3.2-1.8,4.8-2.8
                                        ...
                                        <a href="landuseitem/khorasan-r">
                                            <path class="citymap-name city-khorasan-razavi" data-tooltip="خراسان رضوی"
                                                  d="M696.7,145.5c1.1-1.1,2.2-2.1,3.3-3.1c7.9,2.9,14.5,8.8,23,10.2c2.4,0.1,2.8,2.9,3.6,4.7
                                        ...
                                        <a href="landuseitem/khorasan-sh">
                                            <path class="citymap-name city-khorasan-south" data-tooltip="خراسان جنوبی"
                                                  d="M648,315.4c3.6,2.9,7.6,6,8.8,10.7c0.4,4.3-3.1,8.4-1.7,12.7c2.7,3.1,7.1,3.6,10.9,4.6
                                        ...
                                        <a href="landuseitem/khozestan">
                                            <path class="citymap-name city-khuzestan" data-tooltip="خوزستان" d="M193.8,415.8c4.5,0.7,8.7-1.4,13.1-1.6c2.8,1.4,4.9,3.9,7.7,5.3c3.8,1.5,8.2,1.3,11.9,3.3
                                        ...
                                        <a href="landuseitem/kohgiluyeh-boyer-ahmad">
                                            <path class="citymap-name city-kohgiluyeh-boyer-ahmad"
                                                  data-tooltip="کهگیلویه و بویراحمد" d="M286.2,510.9c3.9,1.3,7.4,3.5,11.3,4.8c2.8,1.1,6,1.5,8.5,3.2c4,4.3,5.5,11.1,11.2,13.7
                                        ...
                                        <a href="landuseitem/kordestan">
                                            <path class="citymap-name city-kurdestan" data-tooltip="کردستان" d="M91.5,209.6c2.7-1.6,5.2,1.1,7.6,2.2c2.5,2,5.7,0.6,8.5,0.3c3.8-0.6,7.5,0.9,11.4,0.9c2.8-0.2,5.3-1.3,8.1-1.6
                                        ...
                                        <a href="landuseitem/lorestan">
                                            <path class="citymap-name city-lorestan" data-tooltip="لرستان" d="M151.7,352c4.3-6.5,8.5-13.4,14.9-18.2c2,2.8,3.9,5.8,6.4,8.2c2.7,2.8,6.7,3.4,10,5.3c3,1.9,5.1,5.2,8.7,6.2
                                        ...
                                        <a href="landuseitem/markazi">
                                            <path class="citymap-name city-markazi" data-tooltip="مرکزی" d="M310.7,261.7c0.8,3.4,1.3,6.9,1.7,10.4c1.9-1.6,3.8-3.3,5.6-4.9c1.4,3.2,3.3,6.4,2.8,10
                                        ...
                                        <a href="landuseitem/mazandaran">
                                            <path class="citymap-name city-mazandaran" data-tooltip="مازندران" d="M306.2,191.4c1.6-1.4,3.4-2.6,5.1-3.8c8,4.7,15.5,10.4,23.9,14.5c5.6,2.9,12.1,2.9,18.1,4.7
                                        ...
                                        <a href="landuseitem/qazvin">
                                            <path class="citymap-name city-qazvin" data-tooltip="قزوین" d="M226.2,203.9c5.4-3,10.1-7.3,15.9-9.3c4.4,1.3,6.1,6.3,9.3,9.3c2,2.7,5.5,3.1,8.6,3.6c5,0.7,9.8,3.7,15,2.7
                                        ...
                                        <a href="landuseitem/qom">
                                            <path class="citymap-name city-qom" data-tooltip="قم" d="M309.7,301.8c4-3.4,5.4-8.5,8.4-12.6c9,0.1,17.1,4.6,26,5.4c1.5,2.2,3.2,4.5,5.7,5.8
                                        ...
                                        <a href="landuseitem/semnan">
                                            <path class="citymap-name city-semnan" data-tooltip="سمنان" d="M556.3,168.1c3.1,3.2,5.3,7.2,6.9,11.4c3,0.1,6,0.1,9-0.2c-2.1,0.7-5,1.1-5.6,3.7c0.5,2.6,1.9,4.8,3,7.1
                                        ...
                                        <a href="landuseitem/sistan-baluchestan">
                                            <path class="citymap-name city-sistan-bluchestan" data-tooltip="بلوچستان"
                                                  d="M828.5,506.7c8.2,2.6,17.1-0.1,25.1,3c4.4,1.6,6.6,6.1,8.8,9.9c1.5,3.2,3.8,6.7,2.5,10.4
                                        ...
                                        <a href="landuseitem/tehran">
                                            <path class="citymap-name city-tehran" data-tooltip="تهران" d="M344.9,243.1c4-1.6,8.5-0.6,12.4,0.8c3.1,1,4.7,3.9,6.7,6.2c3,3.8,6.9,6.7,11.2,8.8c4,1.9,8.5,1.2,12.8,1.3
                                        ...
                                        <a href="landuseitem/yazd">
                                            <path class="citymap-name city-yazd" data-tooltip="یزد" d="M615.8,301.9c4.1-2,7.3-6.1,12.1-6.6c3.4-0.3,7.1-0.8,10.4,0.4c4.9,3.3,8.6,8.4,10.7,13.9
                                        ...
                                        <a href="landuseitem/zanjan">
                                            <path class="citymap-name city-zanjan" data-tooltip="زنجان" d="M169.4,171.6c3.3-1.7,7.1-1.1,10.6-1.1c3.7,0.1,7.3-0.5,11-0.4c3.2,0.1,6,2,9.1,2.7c3.9-0.2,7.7-1.9,11.5-2.8
                                    ...
                                    <g class="map-island">
                                        <path
                                            d="M526.2,844.4c1.2,1.4,2.3,2.9,3.4,4.5c-1.7,0.1-3.4,0.1-5,0.2C525.1,847.4,525.6,845.9,526.2,844.4z"/>
                                        <path
                                            d="M496.4,817.5c0.7-1.3,1.1-2.9,2.4-3.7c1.5,0.6,2.9,1.4,4.3,2.2c0,0.7,0,2.2-0.1,2.9C500.5,820.4,498.3,819.4,496.4,817.5z"/>
                                        <path
                                            d="M498.1,826.5c2.5,0.3,4,1.9,4.4,4.4c-1.5,0-3,0.1-4.5,0.2C498,829.5,498,828,498.1,826.5z"/>
                                        <path
                                            d="M447.7,796.4c1.4-1.1,3.1-1.4,4.8-1.7c1,1.3,2,2.6,3,3.9c-1.7,0.6-3.4,1.2-5.2,1.8C449.4,799,448.4,797.8,447.7,796.4z"/>
                                        <path
                                            d="M570.3,793c2-0.3,3.1,2,2.7,3.8c-1.2,1-2.8,1.3-4.3,1.8C569.1,796.6,568.7,794.3,570.3,793z"/>
                                        ...
                                        <path
                                            d="M537.7,817.3c1.6-0.9,2.9-2.9,5-2.2c1.4,0.7,1.5,2.2,1.4,3.6c-1,0.7-2,1.3-3.1,1.9C539.9,819.4,538.8,818.3,537.7,817.3z"/>
                                        <path
                                            d="M531,821c0.8,0,2.3,0,3,0c0,0.8,0,2.2,0,3c-0.8,0-2.2,0-3,0C531,823.2,531,821.8,531,821z"/>
                                    </g>
                                </svg>
