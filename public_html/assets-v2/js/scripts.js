...
if (document.querySelector('.wrapper-login') !== null) {
  ...
  var btnBackToPhoneNumber = wrapperLogin.querySelector('.btn-back-to-phonenumber');
...
function toastMessage(title, message, type) {
  ...
  wrapper.innerHTML =
    `<div class="alert alert-dismissible fade show toast-content" aria-live="assertive" role="alert" data-bs-autohide="false" aria-atomic="true">
  ...
  $(window).on('scroll', {
    ...
    function () {
      ...
      if (currentTop < this.previousTop) {
        ...
        if (currentTop > headerHeight && !$('#mobile-filter').hasClass('is-fixed')) $('#mobile-filter').addClass('is-fixed');
      }
